    ...
    return (React.createElement(SchemaContext.Provider, { value: { reverse: !reverse, deepExpanded: deepExpand } },
        React.createElement("div", null,
                ...
                rawValue ? (React.createElement("div", null,
                    ...
                    React.createElement("div", null,
                        ...
                        schema.examples() && (React.createElement("ul", { className: "text-xs" },
                            ...
                            _d.map(function (e, idx) { return (React.createElement("li", { key: idx, className: "border inline-block text-orange-600 rounded ml-1 py-0 px-2 break-all" },
                                React.createElement("span", null, SchemaHelpers.prettifyValue(e)))); }))))))),
            isCircular || !isExpandable ? null : (React.createElement("div", { className: "rounded p-4 py-2 border bg-gray-100 ".concat(reverse ? 'bg-gray-200' : '', " ").concat(expanded ? 'block' : 'hidden') },
                ...
                _e.map(function (s, idx) { return (React.createElement(Schema, { key: idx, schema: s, schemaName: SchemaHelpers.applicatorSchemaName(idx, 'Adheres to', 'Or to', s.title()) })); }), (_f = schema
                .anyOf()) === null || _f === void 0 ? void 0 :
                _f.map(function (s, idx) { return (React.createElement(Schema, { key: idx, schema: s, schemaName: SchemaHelpers.applicatorSchemaName(idx, 'Can adhere to', 'Or to', s.title()) })); }), (_g = schema
                .allOf()) === null || _g === void 0 ? void 0 :
                _g.map(function (s, idx) { return (React.createElement(Schema, { key: idx, schema: s, schemaName: SchemaHelpers.applicatorSchemaName(idx, 'Consists of', 'And of', s.title()) })); }),
