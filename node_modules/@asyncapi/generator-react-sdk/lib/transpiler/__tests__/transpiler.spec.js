    ...
    beforeAll(function (done) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, transpiler_1.transpileFiles)(testFiles, outputFiles, {
                            recursive: true
                        })];
                case 1:
                    _a.sent();
    ...
    describe('should transpile CommonJS files', function () {
        describe('with a simple setup', function () {
                ...
                return __generator(this, function (_b) {
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            _a = expect;
                            return [4 /*yield*/, (_c = commonjs_testFile, Promise.resolve().then(function () { return __importStar(require(_c)); }))];
                        case 3:
            ...
            test('and render correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, renderer_1.renderTemplate)(commonjs_testFile, { asyncapi: {}, originalAsyncAPI: "", params: {} })];
                        case 1:
                            content = _a.sent();
                            expect(content === null || content === void 0 ? void 0 : content.content).toBe("hello Test");
                            return [2 /*return*/];
                    }
                });
            }); });
    ...
    describe('should transpile ES5 files', function () {
        describe('with a simple setup', function () {
                ...
                return __generator(this, function (_b) {
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            expect(stripAbsolutePathToReactLib(switchToUnixLinebreaks(mapContent))).toMatchSnapshot();
                            _a = expect;
                            return [4 /*yield*/, (_c = es5_testFile, Promise.resolve().then(function () { return __importStar(require(_c)); }))];
                        case 3:
                            _a.apply(void 0, [_b.sent()]).toBeDefined();
                            return [2 /*return*/];
                    }
            ...
            test('and render correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, renderer_1.renderTemplate)(es5_testFile, { asyncapi: {}, originalAsyncAPI: "", params: {} })];
                        case 1:
                            content = _a.sent();
                            expect(content === null || content === void 0 ? void 0 : content.content).toBe("hello Test");
                            return [2 /*return*/];
    ...
    describe('should transpile ES6 files', function () {
        describe('with a simple setup', function () {
                ...
                return __generator(this, function (_b) {
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            expect(stripAbsolutePathToReactLib(switchToUnixLinebreaks(mapContent))).toMatchSnapshot();
                            _a = expect;
                            return [4 /*yield*/, (_c = es6_testFile, Promise.resolve().then(function () { return __importStar(require(_c)); }))];
                        case 3:
                            _a.apply(void 0, [_b.sent()]).toBeDefined();
                            return [2 /*return*/];
                    }
            ...
            test('and render correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, renderer_1.renderTemplate)(es6_testFile, { asyncapi: {}, originalAsyncAPI: "", params: {} })];
                        case 1:
                            content = _a.sent();
                            expect(content === null || content === void 0 ? void 0 : content.content).toBe("hello Test");
                            return [2 /*return*/];
    ...
    describe('should keep names of files, even if special chars', function () {
        describe('with a simple setup', function () {
                ...
                return __generator(this, function (_b) {
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            expect(stripAbsolutePathToReactLib(switchToUnixLinebreaks(mapContent))).toMatchSnapshot();
                            _a = expect;
                            return [4 /*yield*/, (_c = special_testFile, Promise.resolve().then(function () { return __importStar(require(_c)); }))];
                        case 3:
                            _a.apply(void 0, [_b.sent()]).toBeDefined();
                            return [2 /*return*/];
                    }
            ...
            test('and render correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, renderer_1.renderTemplate)(special_testFile, { asyncapi: {}, originalAsyncAPI: "", params: {} })];
                        case 1:
                            content = _a.sent();
                            expect(content === null || content === void 0 ? void 0 : content.content).toBe("hello Test");
                            return [2 /*return*/];
...
*/
function stripAbsolutePathToReactLib(str) {
    var reactPath = require.resolve('react/cjs/react-jsx-runtime.production.min').replace(/\\/g, '/');
